...
//
// Code for CORBATest::Echo::echoString

// Proxy call descriptor class. Mangled signature:
//  _cstring_i_cstring
class _0RL_cd_597ebdcd862d70e0_00000000
  : public omniCallDescriptor
{
public:
  inline _0RL_cd_597ebdcd862d70e0_00000000(LocalCallFn lcfn, const char* op_, size_t oplen, _CORBA_Boolean upcall=0)
...
void _0RL_cd_597ebdcd862d70e0_00000000::marshalArguments(cdrStream& _n)
{
  _n.marshalString(arg_0,0);

}

void _0RL_cd_597ebdcd862d70e0_00000000::unmarshalArguments(cdrStream& _n)
{
...
void _0RL_cd_597ebdcd862d70e0_00000000::marshalReturnedValues(cdrStream& _n)
{
  _n.marshalString(result,0);

}

void _0RL_cd_597ebdcd862d70e0_00000000::unmarshalReturnedValues(cdrStream& _n)
{
  result = _n.unmarshalString(0);

}

const char* const _0RL_cd_597ebdcd862d70e0_00000000::_user_exns[] = {
  0
};

// Local call call-back function.
static void
_0RL_lcfn_597ebdcd862d70e0_10000000(omniCallDescriptor* cd, omniServant* svnt)
{
  _0RL_cd_597ebdcd862d70e0_00000000* tcd = (_0RL_cd_597ebdcd862d70e0_00000000*)cd;
...
char* CORBATest::_objref_Echo::echoString(const char* msg)
{
  _0RL_cd_597ebdcd862d70e0_00000000 _call_desc(_0RL_lcfn_597ebdcd862d70e0_10000000, "echoString", 11);
...
//
// Code for CORBATest::Echo::echoReversedString

// Local call call-back function.
static void
_0RL_lcfn_597ebdcd862d70e0_20000000(omniCallDescriptor* cd, omniServant* svnt)
{
  _0RL_cd_597ebdcd862d70e0_00000000* tcd = (_0RL_cd_597ebdcd862d70e0_00000000*)cd;
  CORBATest::_impl_Echo* impl = (CORBATest::_impl_Echo*) svnt->_ptrToInterface(CORBATest::Echo::_PD_repoId);
  tcd->result = impl->echoReversedString(tcd->arg_0);


}

char* CORBATest::_objref_Echo::echoReversedString(const char* msg)
{
  _0RL_cd_597ebdcd862d70e0_00000000 _call_desc(_0RL_lcfn_597ebdcd862d70e0_20000000, "echoReversedString", 19);
  _call_desc.arg_0 = msg;
...
CORBATest::_impl_Echo::_dispatch(omniCallHandle& _handle)
{
  ...
  if (omni::strMatch(op, "echoString")) {
    ...
    _0RL_cd_597ebdcd862d70e0_00000000 _call_desc(_0RL_lcfn_597ebdcd862d70e0_10000000, "echoString", 11, 1);
    
    _handle.upcall(this,_call_desc);
    return 1;
  }

  if (omni::strMatch(op, "echoReversedString")) {

    _0RL_cd_597ebdcd862d70e0_00000000 _call_desc(_0RL_lcfn_597ebdcd862d70e0_20000000, "echoReversedString", 19, 1);
